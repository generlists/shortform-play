...
internal class LegacyYouTubePlayerView(
    ...
    init {
        ...
        webViewYouTubePlayer.addListener(
     ...
     * property.
     */
    internal fun isEligibleForPlayback(): Boolean = canPlay || webViewYouTubePlayer.isBackgroundPlaybackEnabled
