...
private const val AUTO_INIT_ERROR =
    "YouTubePlayerView: If you want to initialize this view manually, " +
...
class YouTubePlayerView(
    ...
    LifecycleEventObserver { // SixteenByNineFrameLayout(context, attrs, defStyleAttr), LifecycleEventObserver {
     ...
     */
    private val webViewFullscreenListener =
