...
object EndPoint {
    ...
    const val CATEGORY = "shortformplay/search/category"
    const val DAILY_SHORTS = "shortformplay/search/daily"
    const val PREMIUM_PROMOTION = "shortformplay/promotion"
    const val IAP_VERIFY = "iap/verify"
}
